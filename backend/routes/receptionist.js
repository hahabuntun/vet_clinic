...
router.get("/appointments", get_appointments);
router.post("/appointments/start/:appointment_id", start_appointment);
router.patch("/appointments/cancel/:appointment_id", cancel_appointment);
router.patch("/appointments/approve/:appointment_id", approve_appointment);
router.patch("/appointments/decline/:appointment_id", decline_appointment);
